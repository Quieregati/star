...
function info.onSay(player, words, param)
	...
	player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "Position: " .. string.format("(%0.5d / %0.5d / %0.3d) (%d)", target:getPosition().x, target:getPosition().y, target:getPosition().z, target:getPosition().universe))
